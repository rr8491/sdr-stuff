...
class Lesson1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.channel_freq = channel_freq = 100.507e6
        self.samp_rate = samp_rate = 20e6
        self.channel_width = channel_width = 200e3
        self.center_freq = center_freq = 97.9e6
        self.c_freq = c_freq = channel_freq
        ...
        self._c_freq_range = Range(88.1e6, 107.9e6, 2e4, channel_freq, 200)
        self._c_freq_win = RangeWidget(self._c_freq_range, self.set_c_freq, "'c_freq'", "slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._c_freq_win)
        self._audio_gain_range = Range(0, 10, 1, 1, 200)
        self._audio_gain_win = RangeWidget(self._audio_gain_range, self.set_audio_gain, "'audio_gain'", "dial", float, QtCore.Qt.Horizontal)
    ...
    def set_channel_freq(self, channel_freq):
        ...
        self.set_c_freq(self.channel_freq)
